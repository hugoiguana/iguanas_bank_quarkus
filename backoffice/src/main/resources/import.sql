...
INSERT INTO tb_user_system (us_name, us_birthday_date, us_gender, us_email, us_creation_date, us_alteration_date)
VALUES ('Aline', '1990-01-11', 2, 'aline@test.com', '2021-01-19 16:26:00', '2021-01-19 16:26:00');

INSERT INTO tb_user_system (us_name, us_birthday_date, us_gender, us_email, us_creation_date, us_alteration_date)
VALUES ('Gabriel', '2020-07-02', 1, 'gabriel@test.com', '2021-01-19 16:26:00', '2021-01-19 16:26:00');

INSERT INTO tb_profile (us_id, pro_name)
VALUES ((SELECT 1 FROM tb_user_system us WHERE us.us_email = 'hugo@test.com'), 1)
       ,((SELECT 1 FROM tb_user_system us WHERE us.us_email = 'aline@test.com'), 2)
       ,((SELECT 1 FROM tb_user_system us WHERE us.us_email = 'gabriel@test.com'), 3);
...
, '1234'
, '9'
, (SELECT 1 FROM tb_user_system us WHERE us.us_email = 'gabriel@test.com')
